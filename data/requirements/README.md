...
- 표준화 A/C/E/S 행: 264개
- 교육과정편람 원본: 2016~2026, 11개 연도 연속 확보
- 2012~2015 교육과정편람: 중앙 학사 BBS·통합검색·공식 iBook 공개 색인에서 원문 미발견
...
- 2012~2015 교육과정편람은 공식 공개 색인에서 원문을 찾지 못했다. 이 학번의 학과별 전공필수는 학교 확인 전 `UNKNOWN`으로 처리한다.
- 2016~2025 편람 원문은 확보했지만 모든 학과별 과목표를 정규화한 상태는 아니다. 원문 확보와 자동 판정 가능 상태를 구분한다.
