...
[`docs/API_SPEC.md`](docs/API_SPEC.md)에 정리되어 있습니다.
...
기본 웹 주소는 <http://127.0.0.1:18080>입니다. PostgreSQL 포트는 호스트에 공개하지
않습니다. 실제 스키마의 테이블·관계·제약조건은 [`docs/ERD.md`](docs/ERD.md)에 문서화되어
있습니다. 다른 서버에서도 저장소, `.env`, Docker와 Compose만 있으면 같은 스택을 실행할
수 있습니다.
...
docker compose logs -f api optimizer web db
```
